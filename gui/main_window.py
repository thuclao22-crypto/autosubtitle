...
class MainWindow(QMainWindow):
    ...
    def handle_export_process(self):
        ...
        # Lấy dữ liệu hiện tại từ bảng phụ đề để quyết định Giai đoạn
        ...
        if not table_data:
            ...
            print("--- Đã quét xong! Mời bạn duyệt nội dung trên bảng trước khi nhấn 'XUẤT VIDEO' lần nữa. ---")
            return 
        ...
        style_config = {
            ...
            "primary_color": self.current_color if hasattr(self, 'current_color') else QColor("white"),
        ...
        if os.path.isdir(input_path):
            ...
            print(f"\n--- HOÀN THÀNH: Video lưu tại {current_output} ---")
    ...
    def run_final_render_flow(self, video_path, output_path, style_config):
        ...
        try:
            ...
            self.run_automation_process(
                ...
                is_bilingual, style_config, output_path, None
            )
        except Exception as e:
